...
def main(page: ft.Page):
    ...
    filter_buttons = ft.Row([
        ...
        ft.ElevatedButton("Невыполненные", icon=ft.Icons.STOP_OUTLINED, on_click=lambda e: set_filter("uncompleted"), color=ft.Colors.YELLOW_700),
        ft.ElevatedButton("Выполеннные", icon=ft.Icons.CHECK_BOX, on_click=lambda e: set_filter("completed"), color=ft.Colors.GREEN_700)
